...
import scala.collection.{AbstractIterator, IterableOnce, IterableOps, SortedIterableFactory, StrictOptimizedIterableOps}
...
//  def += (elem: A): this.type =
     ...
     */
    def dequeueAll [A1 >: A] (): scala.collection.immutable.Seq [A1] =
    {
        ...
        ArraySeq.unsafeWrapArray (b.result()).asInstanceOf [ArraySeq [A1]]
    } // dequeueAll
    ...
    def decreaseKey (elem: A, upElem: A)
    {
        if (upElem < elem) {                                                // make sure priority is decreased
            val m = resarr.p_array.asInstanceOf [Array [A]].indexOf (elem)  // find the element in the heap
...
*/
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Create and empty priority queue.
     */
    def empty [A : Ordering]: PriorityQueue [A] = new PriorityQueue [A]

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Create a priority queue from an iterable collection.
     *  @param it
     */
